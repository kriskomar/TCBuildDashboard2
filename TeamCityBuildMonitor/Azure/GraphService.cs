...
namespace TeamCityBuildMonitor.Azure
{
    public static class GraphService
    {
        ...
        public static async Task<string> GetUserJsonAsync(GraphServiceClient graphClient, string email, HttpContext httpContext)
        {
        ...
        public static async Task<string> GetPictureBase64Async(GraphServiceClient graphClient, string email, HttpContext httpContext)
        {
            try
            {
                // Load user's profile picture.
                var pictureStream = await GetPictureStreamAsync(graphClient, email, httpContext);
        ...
        public static async Task<Stream> GetPictureStreamAsync(GraphServiceClient graphClient, string email, HttpContext httpContext)
        {
        ...
        public static async Task<Stream> GetMyPictureStreamAsync(GraphServiceClient graphClient, HttpContext httpContext)
        {
            Stream pictureStream = null;
        ...
        public static async Task SendEmailAsync(GraphServiceClient graphClient, IHostingEnvironment hostingEnvironment, string recipients, HttpContext httpContext)
        {
            ...
            {
                // Load user's profile picture.
                var pictureStream = await GetMyPictureStreamAsync(graphClient, httpContext);
